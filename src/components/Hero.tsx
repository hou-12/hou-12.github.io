            ...
            <div className="container hero-container">
                <div className="hero-layout-grid">
                    ...
                    <div className="hero-text-content">
                        ...
                        >
                            <h1 className="hero-title" aria-label={t('hero.srOnlyTitle')}>
                        ...
                        >
                            <div className="hero-actions">
                                <motion.a
                                    ...
                                    whileHover={{ scale: 1.05, boxShadow: "0 10px 30px rgba(139, 26, 47, 0.4)" }}
                                    whileTap={{ scale: 0.95 }}
                    ...
                    {/* Right Column: Interactive 3D WebGL Neural Orb */}
                    <motion.div
