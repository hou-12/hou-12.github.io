            ...
            <div className="container">
                ...
                <FadeIn delay={80}>
                    <div className="contact-cta-block">
                        <p className="contact-cta-headline gradient-text">
                            Let&apos;s build something great together&nbsp;&rarr;
                        </p>
                        <motion.a
                            href="mailto:houssamhamrouni@gmail.com"
                            className="btn btn-primary contact-btn-primary"
                            whileHover={{ scale: 1.04, boxShadow: '0 10px 40px rgba(139, 26, 47, 0.5)' }}
                            whileTap={{ scale: 0.97 }}
                    ...
                    <FadeIn delay={300}>
                        <div className="contact-info">
                            ...
                            <div className="contact-socials">
                                ...
                                <motion.a
                                    href="https://linkedin.com/in/houssam-hamrouni"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="social-btn"
                                    whileHover={{ y: -3 }}
